...
function [DATA_SET, DATA_SET_mod, TEST_SET, TEST_SET_mod, TARGET_DATA, TARGET_TEST, FILES_LIST_data, FILES_LIST_test] = ML_datacreator_6p_TOIMPROVE_leo(save_name,parentFolder)
